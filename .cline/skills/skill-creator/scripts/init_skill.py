...
Examples:
    init_skill.py my-new-skill --path .cline/skills
    init_skill.py my-api-helper --path .cline/skills
...
def main():
    if len(sys.argv) < 4 or sys.argv[2] != '--path':
        ...
        print("\nExamples:")
        print("  init_skill.py my-new-skill --path .cline/skills")
        print("  init_skill.py my-api-helper --path .cline/skills")
